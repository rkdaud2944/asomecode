### AsomeCODE.Version: canon.py=2 :End.
...
def show():
	print("### System.Line.RunJS: run_cmd('Code=ShowSimulation/Page=canon/')")

def set_angle(a):
	global angle_
	angle_ = a
	print("### System.Line.RunJS: canon_angle(%d)" % (a))

def set_power(p):
	global power_
	power_ = p
	print("### System.Line.RunJS: canon_power(%d)" % (p))
...
def fire():
	print("### System.Line.RunJS: canon_fire()")
