...
$.fn.onscreenKeyboard = function(options){
    ...
    // construct keyboard
        ...
        if ( settings.type ==  'qwerty' ) {
            ...
            $(keyboard).append('<div class="keyRow"><div class="key space-key" data-character="space"><span>space</span></div><div style="width: 50px;" onclick="closeKeyboard();"><img src="/blockeditor/images/icons/icons8-delete-filled.svg" style="width: 20px;"/></div></div>');
