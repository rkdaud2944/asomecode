...
window.show_time = function (time_str) { simulationRunJS(`show_time(${time_str})`) }
window.bullet_move = function () { simulationRunJS(`bullet_move()`) }
window.car_start = function () { simulationRunJS(`car_start()`) }
window.find_next_pixel = function () { simulationRunJS(`find_next_pixel()`) }
window.car_move = function (value) { simulationRunJS(`car_move(${value})`) }